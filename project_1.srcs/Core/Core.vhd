...
begin
    ...
    TEMP_EXEC: block
       ...
       -- Issue control 
       signal --memSubpipeSent,-- mulSubpipeSent,
               -- mulSubpipeAtE0,
               -- fp0subpipeSelected,-- mulSubpipeSelected,
    ...
    begin
        ...
        SUBPIPE_MEM: block
            ...
            signal slotRegReadM0iq, slotRegReadM0_Merged,  slotIssueM0mq --, slotRegReadM0mq
            : SchedulerState := DEFAULT_SCHED_STATE;
