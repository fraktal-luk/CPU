...
architecture Behavioral of RegisterFreeList is
    ...
    signal freeListTakeSel, freeListTakeSel_C, freeListPutSel, stableUpdateSelDelayed, stableTakeUpdate, vsels, psels, overridden: std_logic_vector(0 to PIPE_WIDTH-1) := (others => '0');    
