...
begin
    ...
    if int = '1' then
        if intType = "01" then
            res_O.ip_D := X"00000280";
        else
            res_O.ip_D := RESET_BASE; -- TEMP!
        end if;
        res_O.result_D := currentState or X"00000001";
        res_O.result_D := res_O.result_D and X"fdffffff"; -- Clear dbtrap
    ...
    res.ip := res_O.ip_D;
    res.target := res_O.target_D;
    res.nip := res_O.result_D;
